...
int8_t NRF24L01_Read_Buf(int8_t Reg, int8_t *Buf, int8_t Len)
{
	int8_t Status, i;
	W_SS(0);                    	
	Status =SPI_SwapByte(Reg);		
...
int8_t NRF24L01_Write_Buf(int8_t Reg, int8_t *Buf, int8_t Len)
{
	int8_t Status, i;
	W_SS(0); 
	Status = SPI_SwapByte(Reg);		
...
int8_t NRF24L01_GetRxBuf(int8_t *Buf)
{
	int8_t State;
...
int8_t NRF24L01_SendTxBuf(int8_t *Buf)
{
	uint8_t State;
...
{
	int8_t check_in_buf[5] = {0x11 ,0x22, 0x33, 0x44, 0x55};
	int8_t check_out_buf[5] = {0x00};
...
{	
	...
	NRF24L01_Write_Reg(FLUSH_RX, NOP);									
  	NRF24L01_Write_Buf(nRF_WRITE_REG + TX_ADDR, (int8_t*)TX_ADDRESS, TX_ADR_WIDTH);
  	NRF24L01_Write_Buf(nRF_WRITE_REG + RX_ADDR_P0, (int8_t*)RX_ADDRESS, RX_ADR_WIDTH);   
...
int8_t NRF24L01_Get_Value_Flag()
{
	return R_IRQ();
}
