...
/*图像数据声明*/
extern const uint8_t shizitubiao[];
extern const uint8_t shang1[];
extern const uint8_t shang2[];
extern const uint8_t shang3[];
extern const uint8_t xia1[];
extern const uint8_t xia2[];
extern const uint8_t xia3[];
extern const uint8_t zuo1[];
extern const uint8_t zuo2[];
extern const uint8_t zuo3[];
extern const uint8_t you1[];
extern const uint8_t you2[];
extern const uint8_t you3[];
extern const uint8_t XIAOLIAN[];
